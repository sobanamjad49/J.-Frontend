        ...
        <div className=" sm:block md:hidden lg:hidden  h-11 mb-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <button
                onClick={handleShow}
                className="p-1 ml-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 w-10 h-10 flex items-center justify-center bg-gray-100 hover:bg-gray-200"
                ...
                <Offcanvas.Body>
                  ...
                  >
                    ...
                    >
                      <div>
                        <Link to="Header2" onClick={handleClose}>
                          <p className="font-semibold text-center text-gray-800 hover:text-red-500 hover:border-b-2 hover:border-red-500 mt-3">
                            HOME
                          </p>
                        </Link>
                        <Link to="MainPage" onClick={handleClose}>
                          <p className="font-semibold text-center text-gray-800 hover:text-red-500 hover:border-b-2 hover:border-red-500 mt-3">
                            NEW ARRIVALS
                          </p>
                        </Link>
                        <Link to="Pic84P1" onClick={handleClose}>
                          <p className="font-semibold text-center text-gray-800 hover:text-red-500 hover:border-b-2 hover:border-red-500 mt-3">
                            SYNCC
                          </p>
                        </Link>
                        <Link to="Pic70" onClick={handleClose}>
                          <p className="font-semibold text-center text-gray-800 hover:text-red-500 hover:border-b-2 hover:border-red-500 mt-3">
                            WOMEN
                          </p>
                        </Link>
                        ...
                        <Link to="KIDS" onClick={handleClose}>
                          <p className="font-semibold text-center text-gray-800 hover:text-red-500 hover:border-b-2 hover:border-red-500 mt-3">
                            BOYS & GIRLS
                          </p>
                        </Link>
                        ...
                        <Link to="MakeUp" onClick={handleClose}>
                          <p className="font-semibold text-center text-gray-800 hover:text-red-500 hover:border-b-2 hover:border-red-500 mt-3">
                            MAKEUP
                          </p>
                        </Link>
                    ...
                    >
                      ...
                      <Link to="Header10" onClick={handleClose}>
                        <p className="font-serif font-bold text-xl  mt-3 mb-2">
                          SIGN IN
                        </p>
                      </Link>
                      <hr />
                      <Link to="Header11" onClick={handleClose}>
                        <p className="font-serif font-bold text-xl mt-3 mb-2">
                          TRACKING INFO
                        </p>
                      </Link>
                      <hr />
                      <Link to="Header12" onClick={handleClose}>
                        <p className="font-serif font-bold text-xl mt-3 mb-2">
                          CORPORATE INQUIRY
                        </p>
                      </Link>
                      <hr />
                      <Link to="Header13" onClick={handleClose}>
                        <p className="font-serif font-bold text-xl mt-3 mb-2">
                          CREATE AN ACCOUNT
                        </p>
                      </Link>
            ...
            <div className="flex items-center">
              <button
                className="me-2 p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 w-8 h-8 flex items-center justify-center bg-gray-100 hover:bg-gray-200"
        ...
        <div className="hidden lg:block">
          <div className="flex justify-evenly mt-4 mb-3 ">
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("NEW_ARRIVALS");
              }}
              onMouseLeave={() => {
            ...
            >
              ...
              <div
                className={`hidden group-hover:flex flex-col absolute left-0 p-10 w-full bg-white z-20 text-black ${
                  openDropdown === "NEW_ARRIVALS" ? "flex" : "hidden"
                }`}
              >
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("SYNCC");
              }}
              onMouseLeave={() => {
                setOpenDropdown(null);
                setHoverEnabled(true);
            ...
            >
              ...
              <div
                className={`hidden group-hover:flex flex-col absolute left-0 p-10 w-full bg-white z-20 text-black ${
                  openDropdown === "SYNCC" ? "flex" : "hidden"
                }`}
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                  <p className="text-md font-semibold">
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("WOMEN");
              }}
              onMouseLeave={() => {
                setOpenDropdown(null);
                setHoverEnabled(true);
            ...
            >
              ...
              <div
                className={`hidden group-hover:flex flex-col absolute left-0 p-10 w-full bg-white z-20 text-black ${
                  openDropdown === "WOMEN" ? "flex" : "hidden"
                }`}
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                  <p className="text-md font-semibold">
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("MEN");
              }}
              onMouseLeave={() => {
                setOpenDropdown(null);
                setHoverEnabled(true);
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("BOYS_GIRLS");
              }}
              onMouseLeave={() => {
                setOpenDropdown(null);
                setHoverEnabled(true);
            ...
            >
              ...
              <div
                className={`hidden group-hover:flex flex-col absolute left-0 p-10 w-full bg-white z-20 text-black ${
                  openDropdown === "BOYS_GIRLS" ? "flex" : "hidden"
                }`}
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                  <p className="text-md font-semibold">
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("FRAGRANCES");
              }}
              onMouseLeave={() => {
                setOpenDropdown(null);
                setHoverEnabled(true);
            ...
            >
              ...
              <div
                className={`hidden group-hover:flex flex-col absolute left-0 p-10 w-full bg-white z-20 text-black ${
                  openDropdown === "FRAGRANCES" ? "flex" : "hidden"
                }`}
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                  <p className="text-md font-semibold">
            ...
            <div
              className="group"
              onMouseEnter={() => {
                if (hoverEnabled) setOpenDropdown("MAKEUP");
              }}
              onMouseLeave={() => {
                setOpenDropdown(null);
                setHoverEnabled(true);
            ...
            >
              ...
              <div
                className={`hidden group-hover:flex flex-col absolute left-0 p-10 w-full bg-white z-20 text-black ${
                  openDropdown === "MAKEUP" ? "flex" : "hidden"
                }`}
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                  <p className="text-md font-semibold">
