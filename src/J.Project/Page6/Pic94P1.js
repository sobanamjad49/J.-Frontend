...
const [selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "105",
      size:selectedSize,
      name: "MULTICOLOR WHITE JACQUARD DUPATTA",
      price: 4717.50,
      image:"https://www.junaidjamshed.com/media/catalog/product/j/l/jldp-25-2622.jpg?width=150&height=150&canvas=150,150&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            ...
            <img src="https://www.junaidjamshed.com/media/catalog/product/j/l/jldp-25-2622.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
            </div>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div>
              {/* Product Info */}
              <p className="font-semibold text-lg mt-2">MULTICOLOR WHITE JACQUARD DUPATTA</p>
