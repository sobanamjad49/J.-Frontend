...
<p className="text-md font-semibold mt-3 ml-4 sm:hidden block">9 Items</p>
 ...
 <div className="hidden lg:block mb-3">
   <div className="flex ml-6 ">
            ...
            <p className="ml-6 mt-1 ">9 ITEMS </p>
    ...
    <Link to='/Pic60P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/v/o/vortex.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">VORTEX - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic60P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>

  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic61P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/e/n/enigma.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">ENIGMA - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic61P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>

  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic62P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/p/i/pinnacle.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">PINACLE - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic62P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>

  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic63P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/e/x/exodus.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">EXODUS - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic63P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>

  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic64P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/e/c/eclipse.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">ECLIPSE - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic64P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>

  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic65P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/v/e/velocity.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">VELOCITY - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic65P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>
  
  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic66P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/j/a/janan_oud_2.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">JANAN - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic66P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>

  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic67P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/j/a/janan_platinum.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">JANAN - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic67P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>


  <div class="..." className="lg:hover:bg-white lg:hover:p-2 lg:hover:drop-shadow-2xl">
    <Link to='/Pic68P1'><img  src="https://www.junaidjamshed.com/media/catalog/product/z/a/zarar_body_spray1_1_.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=755&width=589&canvas=589:755&dpr=2"/></Link>
  <p className="ml-2 mb-2 font-semibold hover:underline">ZARAR - NO GAS POUR HOMME BODY SPRAY</p>
  <div className="flex gap-1">
<span className="font-bold ">PKR 800.00</span>
  </div>
  <Link to='/Pic68P1'><button className="border-2 border-black  p-2 mt-2 ml-auto  lg:w-auto w-full  hover:bg-black hover:text-white ">ADD TO BAG</button></Link>
  </div>
