...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "714",
      name: "EXODUS - NO GAS POUR HOMME BODY SPRAY",
      price: 800.0,
      size:selectedSize,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/e/x/exodus.jpg?width=150&height=150&canvas=150,150&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div className="flex justify-center">
              <img src="https://www.junaidjamshed.com/media/catalog/product/e/x/exodus.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
            </div>
          </div>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div>
              ...
              <p className="font-semibold text-lg mt-2">
                {" "}
                EXODUS - NO GAS POUR HOMME BODY SPRAY
              </p>
