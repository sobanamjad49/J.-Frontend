...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 800.0,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/j/a/janan_oud_2.jpg?width=150&height=150&canvas=150,150&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div className="flex justify-center">
              <img src="https://www.junaidjamshed.com/media/catalog/product/j/a/janan_oud_2.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
            </div>
          </div>
