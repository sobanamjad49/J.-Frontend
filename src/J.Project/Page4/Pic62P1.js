...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "713",
      size:selectedSize,
      name: "PINACLE - NO GAS POUR HOMME BODY SPRAY",
      price: 800.00,
      image: "https://www.junaidjamshed.com/media/catalog/product/p/i/pinnacle.jpg?width=150&height=150&canvas=150,150&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            ...
            <img src="https://www.junaidjamshed.com/media/catalog/product/p/i/pinnacle.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
            </div>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div>
              {/* Product Info */}
              <p className="font-semibold text-lg mt-2"> PINACLE - NO GAS POUR HOMME BODY SPRAY</p>
