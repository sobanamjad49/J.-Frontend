...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "719",
      size:selectedSize,
      name: "ZARAR - NO GAS POUR HOMME BODY SPRAY",
      price: 800.0,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/z/a/zarar_body_spray1_1_.jpg?width=150&height=150&canvas=150,150&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-6">
            ...
            <img src="https://www.junaidjamshed.com/media/catalog/product/z/a/zarar_body_spray1_1_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
            </div>
          </div>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div>
              ...
              ZARAR - NO GAS POUR HOMME BODY SPRAY
              </p>
