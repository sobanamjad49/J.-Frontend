...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "115",
      size:selectedSize,
      name: "MATTIFYING EXTREME WEAR FOUNDATION",
      price:6490.00
      ,
      image:"https://www.junaidjamshed.com/media/catalog/product/0/1/01-beige-r.jpg?width=150&height=150&canvas=150,150&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
  ...
  let [change, setChange] = useState(
    <img src="https://www.junaidjamshed.com/media/catalog/product/m/a/mattifying_extreme_wear_foundation.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
  );
  return (
    <div>
      <div class="container">
