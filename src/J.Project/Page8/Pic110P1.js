...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "888",
      size:selectedSize,
      name: "MATTE QUEEN LIQUID LIPSTICK",
      price:6490.00
      ,
      image:"https://www.junaidjamshed.com/media/catalog/product/m/a/matte_queen_liquid_lipstick_16_1__1.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
