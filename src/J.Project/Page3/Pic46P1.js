...
function Pic46P1() {
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "556",
      name: "BROWN COTTON SEMI-FORMAL KURTA",
      price: 12490.5,
      size: selectedSize,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/3/3/33015_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
  ...
  let [change, setChange] = useState(
    <img src="https://www.junaidjamshed.com/media/catalog/product/3/3/33015_2_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
  );
  return (
    <div>
      <div class="container">
          ...
          <div class="col-12 col-md-6 col-lg-6 ">
            ...
            <div className="flex gap-4 justify-center">
              <img
                ...
                src="https://www.junaidjamshed.com/media/catalog/product/3/3/33015_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
              <img
                className="mt-4"
                onClick={() =>
                  setChange(
                    (change = (
                      <img src="https://www.junaidjamshed.com/media/catalog/product/3/3/33015_1_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
                    ))
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/3/3/33015_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
            </div>{" "}
          </div>
