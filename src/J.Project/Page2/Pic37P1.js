...
function Pic37P1() {
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "15334208226",
      size: selectedSize,
      name: "OFF WHITE LAWN  SILK EMBROIDERED SCHIFFLI 3PC STITCHED",
      price: 6917.5,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
  ...
  let [change, setChange] = useState(
    <img src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_1_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
  );
  return (
    <div>
      <div class="container">
          ...
          <div class="col-12 col-md-6 col-lg-6 ">
            ...
            <div className="flex gap-4 justify-center">
              <img
                ...
                src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
              <img
                className="mt-4"
                onClick={() =>
                  setChange(
                    (change = (
                      <img src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_2_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
                    ))
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
              <img
                className="mt-4"
                onClick={() =>
                  setChange(
                    (change = (
                      <img src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_3_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
                    ))
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3252_3_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
            </div>{" "}
          </div>
          ...
          <div class="col-12 col-md-6 col-lg-6 ">
            <div>
              <p className="font-semibold text-lg mt-2">
                OFF WHITE LAWN SILK EMBROIDERED SCHIFFLI 3PC STITCHED
              </p>
