        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-9">
            <div className="hidden sm:hidden md:block lg:hidden">
              ...
              <div className="flex">
                <span className="text-lg font-semibold ">PKR 4,585.00</span>
                <input
            ...
            <div className="hidden lg:block ">
              ...
              <div className="flex mt-4">
                ...
                <p className="text-md font-bold ml-auto">
                  BEIGE LAWN UNSTITCHED 3PC | <br /> JLAWN-S-23-060
                </p>

                <p className="text-lg font-bold ml-auto">PKR 4,585.00</p>
                <input
                  ...
                  onChange={handlechange}
                />
                <p className="text-lg font-bold ml-auto">PKR 77,945.00</p>
              </div>
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div className="p-3  bg-gray-100  ">
              ...
              <div className="flex justify-between">
                ...
                <p className="font-bold ">PKR 4,734.00</p>
              </div>
             <Link to='/Secure'> <button className="p-2 mt-3 w-full font-semibold border-2 border-black hover:bg-black hover:text-white">
                PROCEED TO CHECKOUT
              </button></Link>
            </div>
          </div>
