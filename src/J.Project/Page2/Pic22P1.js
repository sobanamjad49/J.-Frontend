...
function Pic22P1() {
  ...
  const handleAddToCart = () => {
    const product = {
      _id: "6453142",
      name: "  GREEN LAWN SILK EMBROIDERED SCHIFFLI 3PC STITCHED",
      price: 6917.5,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/2/5/25-159_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds",
      size: selectedSize,
    };
