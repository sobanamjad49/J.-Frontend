...
const[selectedSize,setSelectedSize]=useState("")
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 4717.50,
      size:selectedSize,
      image:"https://www.junaidjamshed.com/media/catalog/product/m/a/marjaan-01.jpg?width=83&height=110&canvas=83,110&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
  ...
  let [change, setChange] = useState(
    <img src="https://www.junaidjamshed.com/media/catalog/product/m/a/marjaan-01.jpg?width=420&height=560&canvas=420,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
  );
  return (
    <div>
      <div class="container">
          ...
          <div class="col-12 col-md-6 col-lg-6 ">
            ...
            <div className="flex gap-4 justify-center">
              <img
                ...
                src="https://www.junaidjamshed.com/media/catalog/product/m/a/marjaan-01.jpg?width=83&height=110&canvas=83,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
              <img
                className="mt-4"
                onClick={() =>
                  setChange(
                    (change = (
                      <img src="https://www.junaidjamshed.com/media/catalog/product/m/a/marjaan-03.jpg?width=420&height=560&canvas=420,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
                    ))
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/m/a/marjaan-03.jpg?width=83&height=110&canvas=83,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
