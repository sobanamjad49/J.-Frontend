...
function Pic1P1() {
  ...
  let [change, setChange] = useState(
    <img src="https://www.junaidjamshed.com/media/catalog/product/8/1/810_1_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
  );
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 5917.5,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/8/1/810_1_.jpg",
          ...
          <div className="col-12 col-md-6 col-lg-6">
            ...
            <div className="flex gap-4 justify-center">
              <img
                ...
                src="https://www.junaidjamshed.com/media/catalog/product/8/1/810_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
              <img
                className="mt-4"
                onClick={() =>
                  setChange(
                    (change = (
                      <img src="https://www.junaidjamshed.com/media/catalog/product/8/1/810_2_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds" />
                    ))
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/8/1/810_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
              <img
                className="mt-4"
                onClick={() =>
                  setChange(
                    (change = (
                      <img src="https://www.junaidjamshed.com/media/catalog/product/8/1/810_3_.jpg?width=700&height=545&canvas=700,545&optimize=medium&bg-color=255,255,255&fit=bounds" />
                    ))
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/8/1/810_3_.jpg?width=88&height=69&canvas=88,69&optimize=medium&bg-color=255,255,255&fit=bounds"
              />{" "}
            </div>{" "}
          </div>
