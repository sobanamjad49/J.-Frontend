...
function Pic15P1() {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 4867.5,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/3/0/3079_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
  ...
  const [change, setChange] = useState(
    "https://www.junaidjamshed.com/media/catalog/product/3/0/3079_2_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"
  );
          ...
          <div className="col-12 col-md-6 col-lg-6">
            ...
            <div className="flex gap-4 justify-center mt-4">
              <img
                ...
                src="https://www.junaidjamshed.com/media/catalog/product/3/0/3079_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
                alt="Thumbnail 1"
              />
              <img
                className="w-[86px] h-[110px] object-cover cursor-pointer"
                onClick={() =>
                  setChange(
                    "https://www.junaidjamshed.com/media/catalog/product/3/0/3079_1_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/3/0/3079_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
                alt="Thumbnail 2"
              />
              <img
                className="w-[86px] h-[110px] object-cover cursor-pointer"
                onClick={() =>
                  setChange(
                    "https://www.junaidjamshed.com/media/catalog/product/3/0/3079_3_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/3/0/3079_3_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
                alt="Thumbnail 3"
              />
            </div>
          </div>
