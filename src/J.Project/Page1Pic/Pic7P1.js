...
function Pic7P1() {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      size: selectedSize,
      image:
        "https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds",
    };
  ...
  let [change, setChange] = useState(
    "https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_1_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"
  );
  return (
    <div>
      <div class="container">
          ...
          <div class="col-12 col-md-6 col-lg-6 ">
            ...
            <div className="flex gap-4 justify-center mt-4">
              <img
                ...
                src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_1_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
                alt="Thumbnail 1"
              ...
              <img
                ...
                onClick={() =>
                  setChange(
                    "https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_2_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_2_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
                alt="Thumbnail 2"
                class="w-[86px] h-[110px] object-cover"
              />
              <img
                ...
                onClick={() =>
                  setChange(
                    "https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_3_.jpg?width=436&height=560&canvas=436,560&optimize=medium&bg-color=255,255,255&fit=bounds"
                  )
                }
                src="https://www.junaidjamshed.com/media/catalog/product/2/5/25-3215_3_.jpg?width=86&height=110&canvas=86,110&optimize=medium&bg-color=255,255,255&fit=bounds"
                alt="Thumbnail 3"
                class="w-[86px] h-[110px] object-cover"
              />
            </div>
